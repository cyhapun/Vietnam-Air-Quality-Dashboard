...
def render_navigation(active_tab: str):
    ...
    if not st.session_state.get("_az_nav_css_injected"):
        st.markdown(
            """
            <style>
            .az-nav-host {
            ...
            .az-nav:hover {
              width: 244px;
              box-shadow: 12px 0 34px rgba(15,23,42,0.36);
            }
            .az-nav-item {
              display: flex;
              align-items: center;
            ...
            .az-nav-item:hover {
              background: rgba(31,79,125,.46);
              border-color: rgba(148,184,214,.36);
              color: #f1f5f9;
            ...
            .az-nav-label {
              ...
              transition: opacity .2s ease .06s,max-width .24s cubic-bezier(.22,1,.36,1),transform .2s ease .06s;
            }
        ...
        st.session_state["_az_nav_css_injected"] = True
